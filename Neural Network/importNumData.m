function patients1 = importNumData(filename, dataLines)
%IMPORTFILE Import data from a text file
%  PATIENTS1 = IMPORTFILE(FILENAME) reads data from text file FILENAME
%  for the default selection.  Returns the numeric data.
%
%  PATIENTS1 = IMPORTFILE(FILE, DATALINES) reads data for the specified
%  row interval(s) of text file FILENAME. Specify DATALINES as a
%  positive scalar integer or a N-by-2 array of positive scalar integers
%  for dis-contiguous row intervals.
%
%  Example:
%  patients1 = importNumData("C:\Users\konstantina\Desktop\MATLAB\diplomatiki\Neural Network\patients.txt", [1, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 10-Feb-2023 19:56:25
...
% Import the data
patients1 = readtable(filename, opts);

%% Convert to output type
patients1 = table2array(patients1);
end